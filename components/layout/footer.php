<footer id="footer" class="bg-sombre">
    <div class="row mx-auto p-3">
        <article class="col-12 col-lg-4 mb-3">
            <h3 class="text-center color-gold mb-5">Gringotts Banque - 2021</h3>
        </article>
        <article class="col-12 col-lg-4 mb-3">
        ...
        <article class="col-12 col-lg-4 mb-3">
            <h3 class="text-center color-gold mb-5">Contact</h3>
            <ul class="list-group list-group-flush">
                <li class="bg-sombre color-gold row align-items-center mb-3">
                    <div class="col-3 text-center">
                        <i class="fas fa-building"></i>
                    </div>
                    <div class="col-9">
                        <p class="m-0">Chemin de Traverse<br>London UK</p>
                    </div>
                </li>
                <li class="bg-sombre color-gold row align-items-center mb-3">
                    <div class="col-3 text-center">
                ...
                <li class="bg-sombre color-gold row align-items-center mb-3">
                    ...
                    <div class="col-9">
                        <p class="m-0">contact@gringotts.london</p>
                    </div>
                </li>
            </ul>
        </article>
